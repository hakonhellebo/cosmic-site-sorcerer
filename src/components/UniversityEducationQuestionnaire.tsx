...
const UniversityEducationQuestionnaire = ({ form, onSubmit }) => {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold mb-4">Utdanning</h2>
        <p className="text-muted-foreground mb-6">Fortell oss om din utdanningsbakgrunn</p>
...
export default UniversityEducationQuestionnaire;
