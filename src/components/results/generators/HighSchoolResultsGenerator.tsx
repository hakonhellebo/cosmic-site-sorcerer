...
interface HighSchoolResultsGeneratorProps {
  userData: any;
}

const HighSchoolResultsGenerator: React.FC<HighSchoolResultsGeneratorProps> = ({ userData }) => {
...
export default HighSchoolResultsGenerator;
