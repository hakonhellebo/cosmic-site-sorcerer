...
interface UniversityResultsGeneratorProps {
  userData: any;
}

const UniversityResultsGenerator: React.FC<UniversityResultsGeneratorProps> = ({ userData }) => {
...
export default UniversityResultsGenerator;
