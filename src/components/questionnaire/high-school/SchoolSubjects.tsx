...
const SchoolSubjects = ({
  ...
  return <div className="space-y-6">
      ...
      <div className="space-y-4">
        <FormField control={form.control} name="highSchool.bestSubjects" render={() => <FormItem>
              <FormLabel className="text-base font-medium">Hvilke fag liker du best på skolen? (Velg opptil 3)</FormLabel>
            ...
            id: "programming",
            label: "Programmering/teknologi"
          }, {
            id: "other",
            label: "Annet"
          }].map(item => <FormField key={item.id} control={form.control} name={`highSchool.bestSubjects.${item.id}`} render={({
            field
              ...
              <div className="mt-2">
                <FormField control={form.control} name="highSchool.bestSubjectsOther" render={({
            field
          }) => <FormItem>
                      <FormLabel className="sr-only">Annet fag</FormLabel>
                      <FormControl>
                        <Input placeholder="Skriv inn annet fag du liker" {...field} className={!form.watch('highSchool.bestSubjects.other') ? 'opacity-50' : ''} disabled={!form.watch('highSchool.bestSubjects.other')} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
              </div>
      ...
      <div className="space-y-4">
        <FormField control={form.control} name="highSchool.challengingSubjects" render={() => <FormItem>
              <FormLabel className="text-base font-medium">Hvilke fag synes du er mest utfordrende? (Velg opptil 3)</FormLabel>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
                {[{
            id: "maths",
            label: "Matematikk"
            ...
            id: "other",
            label: "Annet"
          }].map(item => <FormField key={item.id} control={form.control} name={`highSchool.challengingSubjects.${item.id}`} render={({
            field
          }) => <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <FormControl>
                          <Checkbox checked={field.value} onCheckedChange={field.onChange} />
              ...
              <div className="mt-2">
                <FormField control={form.control} name="highSchool.challengingSubjectsOther" render={({
            field
          }) => <FormItem>
                      <FormLabel className="sr-only">Annet fag</FormLabel>
                      <FormControl>
                        <Input placeholder="Skriv inn annet fag du finner utfordrende" {...field} className={!form.watch('highSchool.challengingSubjects.other') ? 'opacity-50' : ''} disabled={!form.watch('highSchool.challengingSubjects.other')} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
              </div>
      ...
      {/* Learning Style */}
      <div className="space-y-4">
        <FormField control={form.control} name="highSchool.learningStyle" render={() => <FormItem>
      ...
      {/* Digital Tools */}
      <div className="space-y-4">
        <FormField control={form.control} name="highSchool.digitalTools" render={() => <FormItem>
