            ...
            <FormControl>
              ...
              >
                ...
                <FormItem className="flex items-center space-x-3 space-y-0">
                  ...
                  <FormLabel className="font-normal">VGS</FormLabel>
                </FormItem>
                <FormItem className="flex items-center space-x-3 space-y-0">
                  <FormControl>
          ...
          <FormItem>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
              {[
                ...
                { id: "socialStudies", label: "Samfunnsfag" },
                { id: "science", label: "Naturfag" },
                { id: "physEd", label: "Kroppsøving" },
                { id: "artsCrafts", label: "Kunst og håndverk" },
                { id: "foreignLanguage", label: "Fremmedspråk" },
                { id: "other", label: "Annet" },
              ].map((item) => (
                <FormField
                  key={item.id}
                  control={form.control}
                  name={`highSchool.favoriteCourses.${item.id}`}
                  render={({ field }) => (
            ...
            <div className="mt-2">
              <FormField
                control={form.control}
                name="highSchool.favoriteCoursesOther"
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input 
                        placeholder="Skriv inn andre fag" 
                        {...field} 
                        className={form.getValues('highSchool.favoriteCourses.other') ? "" : "hidden"}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
        ...
        render={() => (
          <FormItem>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
              {[
                ...
                <FormField
                  key={item.id}
                  control={form.control}
                  name={`highSchool.difficultCourses.${item.id}`}
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      <FormControl>
                        <Checkbox
            ...
            <div className="mt-2">
              <FormField
                control={form.control}
                name="highSchool.difficultCoursesOther"
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input 
                        placeholder="Skriv inn andre fag" 
                        {...field} 
                        className={form.getValues('highSchool.difficultCourses.other') ? "" : "hidden"}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
      ...
      <FormField
        ...
        render={() => (
          <FormItem>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
              {[
                { id: "salary", label: "Få en godt betalt jobb" },
                { id: "interest", label: "Følge interessene mine" },
                { id: "security", label: "Ha trygg jobb" },
                { id: "flexibility", label: "Ha en fleksibel arbeidshverdag" },
                { id: "meaning", label: "Jobbe med noe meningsfullt" },
                { id: "status", label: "Oppnå høy status" },
              ].map((item) => (
                <FormField
                  key={item.id}
                  control={form.control}
                  name={`highSchool.educationPriorities.${item.id}`}
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      <FormControl>
                        <Checkbox
