...
interface CareerDecisionsProps {
  form: UseFormReturn<any>;
}

const CareerDecisions: React.FC<CareerDecisionsProps> = ({
  form,
}) => {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold">Karrierebeslutninger</h2>
      <p className="text-muted-foreground mb-6">Fortell oss om dine fremtidsplaner og motivasjon</p>
